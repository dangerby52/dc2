...
client.on('message',msg=>{
  ...
  if (msg.content.toLowerCase().match(/(porn|nude|fuck|porno|siktir|orospu|çocuğu|cocugu|sikiş|sikeyim|sikim|sikerim|oç|sikik|sikiş|31)/g) && msg.channel.type === "text" && msg.channel.permissionsFor(msg.guild.member(client.user)).has("MANAGE_MESSAGES")) {
